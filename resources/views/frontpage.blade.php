                ...
                <div class="card-body">
                    <ul class="list-group">
                       <form action="{{ route('frontpage') }}" method="GET">
                           <input type="submit" value="All" class="list-group-item list-group-item-action">
                       ...
                       <p class="mx-auto">Result: {{ count($pizzas) }} pizza</p>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                   <div class="row">
                       @forelse ($pizzas as $pizza)
                            <div class="col-md-4 p-2 text-center" style="border: 1px solid #ccc">
